...
class DmnEvaluationTest {
  ...
  static void parseDecisions() {
    ...
    vehicleDecision = parse("processes/vehicle-auto-approval.dmn", "vehicle-auto-approval");
    businessDecision = parse("processes/business-auto-approval.dmn", "business-auto-approval");
  }
