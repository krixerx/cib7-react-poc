 ...
 * KeycloakAuthenticationFilter} to push the user into the CIB seven {@link IdentityService}.
 *
  ...
  public SecurityFilterChain httpSecurityRest(HttpSecurity http, JwtDecoder jwtDecoder)
    ...
    return http.securityMatcher(antMatcher("/engine-rest/**"))
        ...
        .oauth2ResourceServer(
            oauth2ResourceServer ->
                oauth2ResourceServer.jwt(jwt -> jwt.decoder(jwtDecoder).jwkSetUri(jwkSetUri)))
