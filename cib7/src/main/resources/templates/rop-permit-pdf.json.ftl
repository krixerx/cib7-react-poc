<#--
  pdf-renderer /render payload for Task_RopPermitPdf in
  rop-learning-permit.bpmn. One document carries the electronic learning
...
<body>
  <div class="border">
    ...
    <p style="font-size: 0.95rem; line-height: 1.5; margin-top: 0;">
      ...
      licensed driving instructor, Sultanate of Oman.
    </p>
    ...
    <div class="receipt">
      ...
      <table>
        ...
        <tr><th>Service fee</th><td>6.000 OMR &mdash; paid</td></tr>
...
</#assign>
{
  ...
  "filename": "rop-learning-permit-${execution.processInstanceId?json_string}.pdf"
}
