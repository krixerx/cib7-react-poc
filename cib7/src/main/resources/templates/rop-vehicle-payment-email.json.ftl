<#--
  Mailpit /api/v1/send payload for Task_RopVehiclePaymentEmail in
  rop-vehicle-registration.bpmn. The officer approved; the applicant must
  ...
  registrationFee (Double from the rop-vehicle-fee DMN — defensively
...
Registration fee:  ${feeAmount?string("0.000")} OMR
