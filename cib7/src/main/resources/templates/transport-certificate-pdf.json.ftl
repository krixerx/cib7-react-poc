<#--
  pdf-renderer /render payload for Task_TransportCertificatePdf in
  transport-vehicle-registration.bpmn. Renders the Transport Vehicle Registration
...
<body>
  <div class="border">
    ...
    <p style="font-size: 0.95rem; line-height: 1.5; margin-top: 0;">
      ...
      the register of the Transport Authority.
    </p>
    ...
    <table>
      ...
      <tr><th>Registration fee paid</th><td>${feeAmount?string("0.000")} EUR</td></tr>
    </table>
...
</#assign>
{
  ...
  "filename": "transport-registration-certificate-${execution.processInstanceId?json_string}.pdf"
}
