 ...
 */
@Component
public class TransportSeedData {

  private static final Logger LOG = LoggerFactory.getLogger(TransportSeedData.class);

  private final VehicleClearanceRepository vehicleClearances;
  private final DriverClearanceRepository driverClearances;

  public TransportSeedData(
  ...
  public void seed() {
    ...
    vehicleClearances.save(new VehicleClearance("DEMOFAILINSP01", false, true, true));
    vehicleClearances.save(new VehicleClearance("DEMONOINSURE02", true, false, true));
    vehicleClearances.save(new VehicleClearance("DEMOFINESDUE03", true, true, false));
    ...
    LOG.info("Seeded demo clearance rows (3 vehicle VINs, 5 driver civil IDs).");
  }
}
