# Decision: `rop-vehicle-eligibility`

**Decision id:** `rop-vehicle-eligibility`
**BPMN business rule task:** `Task_RopVehicleEligibility`
**Output variable:** `eligibilityDecision` (single entry)
**History TTL:** `P30D` (matches the BPMN's process TTL)

Implements the "General Conditions" and "Special conditions" tables of ROP
