# Service task: `rop-vehicle-rejection-email`

**BPMN task:** `Task_RopVehicleRejectionEmail`
...
`cib7/src/main/resources/templates/rop-vehicle-rejection-email.json.ftl`.
...
`process@cib7-poc.local`, name "Royal Oman Police — General Traffic
