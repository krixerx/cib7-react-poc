# Service task: `rop-clearance-check`

**BPMN task:** `Task_RopClearanceCheck`
...
| HTTP | URL | Headers |
|---|---|---|
| GET | `${apiBaseUrl}/api/public/rop/vehicle-clearance/${vin}` | `Accept: application/json` |
...
VINs (`ROPDEMOFAILINSP01`, `ROPDEMONOINSURE02`, `ROPDEMOFINESDUE03`)
trigger the rejection branches. Backed by the `rop_vehicle_clearances`
