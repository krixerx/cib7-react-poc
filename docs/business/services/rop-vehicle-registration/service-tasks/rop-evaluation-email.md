# Service task: `rop-evaluation-email`

**BPMN task:** `Task_RopEvaluationEmail`
...
`cib7/src/main/resources/templates/rop-evaluation-email.json.ftl`.
...
Sender "Royal Oman Police — General Traffic Department"; subject "How was
