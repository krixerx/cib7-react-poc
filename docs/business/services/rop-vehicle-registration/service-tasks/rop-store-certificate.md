# Service task: `rop-store-certificate`

**BPMN task:** `Task_RopStoreCertificate`
...
`cib7/src/main/resources/templates/rop-store-certificate.json.ftl` —
mirror of `server-upload-certificate.json.ftl`:

```json
{
  "processInstanceId": "${execution.processInstanceId}",
  "filename": "${certificatePdfFilename!\"rop-registration-certificate.pdf\"}",
