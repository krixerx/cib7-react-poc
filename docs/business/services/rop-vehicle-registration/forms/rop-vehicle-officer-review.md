# Form: `rop-vehicle-officer-review`

**Form id:** `rop-vehicle-officer-review` (kebab-case, globally unique)
**BPMN task:** `Task_RopVehicleOfficerReview`
**Audience:** `civil-servant` group (plays the ROP Traffic Officer)
...
| Registration fee | `registrationFee` + " OMR" |
