# Service task: `rop-permit-email`

**BPMN task:** `Task_RopPermitEmail`
...
`cib7/src/main/resources/templates/rop-permit-email.json.ftl`.
...
receipt. Attachment via `${pdf.encode(permitPdfBytes)}`. Sender "Royal
Oman Police — General Traffic Department"; subject "Your driving learning
