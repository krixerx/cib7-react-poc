# Service task: `rop-issue-permit`

**BPMN task:** `Task_RopIssuePermit`
...
`rop_learning_permits`, JPA entity `LearningPermitRecord`) and returns
...
| HTTP | URL | Headers |
|---|---|---|
| POST | `${apiBaseUrl}/api/public/rop/learning-permits/issue` | `Content-Type: application/json`, `Accept: application/json` |

## Payload

FreeMarker template at
`cib7/src/main/resources/templates/rop-issue-permit.json.ftl`:
