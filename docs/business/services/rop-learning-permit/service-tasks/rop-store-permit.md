# Service task: `rop-store-permit`

**BPMN task:** `Task_RopStorePermit`
...
`cib7/src/main/resources/templates/rop-store-permit.json.ftl`:

```json
{
  "processInstanceId": "${execution.processInstanceId}",
  "filename": "${permitPdfFilename!\"rop-learning-permit.pdf\"}",
