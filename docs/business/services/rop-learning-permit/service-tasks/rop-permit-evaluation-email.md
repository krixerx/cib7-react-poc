# Service task: `rop-permit-evaluation-email`

**BPMN task:** `Task_RopPermitEvaluationEmail`
...
`cib7/src/main/resources/templates/rop-permit-evaluation-email.json.ftl`.
...
survey link is illustrative. Sender "Royal Oman Police — General Traffic
