# Decision: `rop-permit-eligibility`

**Decision id:** `rop-permit-eligibility`
**BPMN business rule task:** `Task_RopPermitEligibility`
**Output variable:** `permitDecision` (single entry)
**History TTL:** `P30D` (matches the BPMN's process TTL)

Implements the "Terms of Service" list of ROP Demo Scenario 2 — *"The
