# Decision: `transport-vehicle-fee`

**Decision id:** `transport-vehicle-fee`
**BPMN business rule task:** `Task_TransportVehicleFee`
...
table (amounts in EUR). The applicant form shows the same table as a live
...
|---|---|---|---|
| Registration fee | `double` | `registrationFee` | EUR amount |
