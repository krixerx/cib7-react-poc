# transportVehicleRegistration — guidance for the LLM

A service requester registers a new vehicle with the General Traffic
Department of the Transport Authority (ITS Demo Scenario 1). The
...
outstanding restrictions, validates the local registration conditions,
...
- **vehicleCategory** — one of the 12 fee-schedule categories; fees in
  EUR: motorcycle 10; private cars by engine size 15 / 20 / 30 / 50;
...
- *"How much does it cost?"* — by category, 10–180 EUR; see the fee
