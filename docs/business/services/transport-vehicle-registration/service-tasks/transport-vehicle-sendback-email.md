# Service task: `transport-vehicle-sendback-email`

**BPMN task:** `Task_TransportVehicleSendbackEmail`
...
The flow then loops to `Task_TransportVehicleApplication`.
...
`cib7/src/main/resources/templates/transport-vehicle-sendback-email.json.ftl`.
...
case in the portal, fix the data, and resubmit. Sender "Transport Authority —
Transport Authority"; subject "Your vehicle registration
