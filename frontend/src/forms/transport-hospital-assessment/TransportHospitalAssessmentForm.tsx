...
/**
 * Police Hospital medical assessment form for transportLearningPermit (PartB) —
 * ITS Demo Scenario 2. The civil-servant group plays the hospital
 ...
 * docs/business/services/transport-learning-permit/forms/transport-hospital-assessment.md
 */
export default function TransportHospitalAssessmentForm({
  data,
  onComplete,
  submitting,
  readOnly,
}: FormProps) {
  const { t } = useTranslation('transport-hospital-assessment');
